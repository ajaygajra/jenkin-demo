...
const appId = "6e13b23d7a3",
    ...
    describe('Initializing CometChat SDK without APPID.', function () {
    ...
    describe('Initializing CometChat SDK with APPID', function () {
        this.timeout(10000);        
    ...
    describe("Login to CometChat",function(){
        it('Should fail on blank userid', function (done) {
